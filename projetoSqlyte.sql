...
--Criando tabela dos tipos de transações dos clientes
...
--Criando tabela de trasanção bancárias dos clientes.
...
-- mostrar dados da tabela conta 
SELECT * FROM conta

--mostrar dados da tabela cliente_conta
